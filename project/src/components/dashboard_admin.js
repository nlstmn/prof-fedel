...
export default class DashboardComponentAdmin extends Component {
    ...
    onSliderChangeP = (values, key) => {
        const newTableData = [...this.state.tableData]
        newTableData[key].p_rate = parseInt(values)
        this.setState({
            valuesP: values,
    ...
    onSaveTableApi = () => {
        Axios.post(api + "saveTable", {
            ...
            toast.success('Result is submitted!', {
                position: "bottom-right",
                autoClose: 1000,
                hideProgressBar: true,
                closeOnClick: true,
    ...
    render() {
        ...
        return (
            <div className="pt-3 pb-5">
                <div className="logout-div pt-4">
                    <Button variant="primary" type="button" className="orange-button mr-2" onClick={this.onLogout}>
                        Log out
                    </Button>
                </div>
                <h2 className="heading py-4">Admin: {this.props?.userData?.data?.[0].email}</h2>
                                                ...
                                                <td colSpan="1" className='w-40'>
                                                    ...
                                                    <div className="py-3 student-range">
                                                        <Range
                                                            ...
                                                            min={MIN}
                                                            max={MAX}
                                                            onChange={(values) => this.onSliderChangeP(values, k)}
                                                            renderTrack={({ props, children }) => (
                                                                <div
                                                                    onMouseDown={props.onMouseDown}
                                                                    onTouchStart={props.onTouchStart}
